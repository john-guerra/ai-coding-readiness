 ...
 *
 * The opening fence LINE is excluded from what is kept. That line is the
 * delimiter plus its info string (```bash), and a language tag is never a
 * command — crediting it let a `bash`-launched script "pass" on a fence whose
 * body was `git status`, with the evidence quoting the literal string
