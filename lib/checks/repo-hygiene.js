...
/**
 * Drop comment lines and `!`-negations before matching against
 * `IGNORE_REQUIREMENTS`. A commented-out mention or a negated entry does not
 * mean the pattern is actually ignored.
 * @param {string} text
 * @returns {string}
 */
